package org.liamjd.rightnotes.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = org.liamjd.rightnotes.core.api as Api<T>
    override val config: ApplicationConfig = org.liamjd.rightnotes.core.config
}
